                ...
                <div class="footer-lists">
                    <ul class="list">
                        ...
                        <li class="list-body">
                            ...
                            <p class="mt-3">
                                Copyright <script>document.write(new Date().getFullYear())</script> &copy; Tran Minh Duc 20810206
                            </p>                   
                        </li>
                    </ul>
                    <ul class="list">
                        ...
                        <li class="list-body">
                            <div class="row">
                                <div class="col">
                                    <a href="./">Trang chủ</a>
                                    <a href="/">My host</a>
                                    <a href="./demo20810206.php">Demo php cơ bản</a>
                                </div>
                            </div>
                        </li>
                    </ul>
                    <ul class="list">
                        ...
                        <li class="list-body">
                            ...
                            <p><i class="ti-location-pin"></i> HCM city</p>
